(function() {
  ...
  BotchanDatabase.prototype.reset = function() {
    ...
    this.add_function("^(who is|who\'?s) your (wife|waifu)", 3, function(input, name, icon) {
      console.log(this);
      var rand = Math.floor(Math.random() * this.shiplist.length);
      //Speak(this.shiplist[rand] + ".");
      return true;
    });
  }
})();
